...
個人粉絲團網站首頁 / 角色介紹頁。
整體風格需呈現：
精緻夢幻的個人品牌官網 × 社交平台主頁 × 乙女遊戲角色介紹頁，而不是單純人物海報。
請將所有內容整合於同一張完整畫面中，
採用分區式 UI 排版，版面需整齊、
有層次、資訊清楚，避免形成文字牆。
③《生成咒語》②（區塊內容）
...
✦ 畫面設計要求
* 使用繁體中文，並可搭配少量英文小標題
（如 About Me、Gallery、Lifestyle）
* 整體需呈現「真實在經營的粉絲團首頁」質感
* UI 分區明確、邊框清楚、排版精緻
* 所有圖片需為同一角色，保持五官、瞳色與氣質一致
* 各區塊縮圖需呈現不同穿搭與造型變化
* 避免所有畫面重複同一服裝或配件
✦ 畫風關鍵詞
